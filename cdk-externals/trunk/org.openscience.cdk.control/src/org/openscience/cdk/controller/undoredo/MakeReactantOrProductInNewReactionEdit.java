...
public class MakeReactantOrProductInNewReactionEdit implements IUndoRedoable {
	...
	public MakeReactantOrProductInNewReactionEdit(IChemModel chemModel, IAtomContainer ac, IAtomContainer oldcontainer, boolean reactantOrProduct, String type) {
		...
		this.reactionID = ReactionSetManipulator.getRelevantReaction(chemModel.getReactionSet(), movedContainer).getID();
	...
	public void undo() {
		...
		chemModel.getReactionSet().removeReaction(ReactionSetManipulator.getRelevantReaction(chemModel.getReactionSet(), movedContainer));
	}
