...
public class MakeReactantOrProductInExistingReactionEdit implements IUndoRedoable {
	...
	public void redo() {
		...
		IReaction reaction = ReactionSetManipulator.getRelevantReaction(chemModel.getReactionSet(), reactionID);
	...
	public void undo() {
		...
		if(reactantOrProduct)
			reactantsorproducts = ReactionSetManipulator.getRelevantReaction(chemModel.getReactionSet(), reactionID).getReactants();
		else
			reactantsorproducts = ReactionSetManipulator.getRelevantReaction(chemModel.getReactionSet(), reactionID).getProducts();
		int count=0;
