...
public class ReactionArrowGenerator  implements IReactionGenerator {
	...
	public IRenderingElement generate(IReaction reaction, RendererModel model) {
        ...
        double DISTANCE = model.getBondLength() / model.getScale();
        return new ArrowElement(totalBoundsReactants.getMaxX()+DISTANCE, totalBoundsReactants.getCenterY(), totalBoundsProducts.getMinX()-DISTANCE, totalBoundsReactants.getCenterY(),1 / model.getScale(),true,model.getForeColor());
	}
}
