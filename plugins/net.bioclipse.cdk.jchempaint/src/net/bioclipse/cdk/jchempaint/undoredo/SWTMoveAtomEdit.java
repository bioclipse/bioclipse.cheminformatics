 ...
 */
public class SWTMoveAtomEdit extends MoveAtomEdit implements IUndoableOperation {

    private IUndoContext context;

    public SWTMoveAtomEdit(IAtomContainer undoRedoContainer, Vector2d offset,
