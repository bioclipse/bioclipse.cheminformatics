		...
		if(parentElement instanceof IContainer && ((IContainer)parentElement).isAccessible()){
			try {
				for(int i=0;i<((IContainer)parentElement).members().length;i++){
					if(((IContainer)parentElement).members()[i] instanceof IFile && (((IFile)((IContainer)parentElement).members()[i]).getFileExtension()!=null && ((((IFile)((IContainer)parentElement).members()[i]).getFileExtension().equals(ICDKManager.mol)) || ((IFile)((IContainer)parentElement).members()[i]).getFileExtension().equals(ICDKManager.cml)))){
