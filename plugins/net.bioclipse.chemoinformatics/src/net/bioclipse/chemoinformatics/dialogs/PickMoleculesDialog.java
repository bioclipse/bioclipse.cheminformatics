...
/**
 * A dialog for selecting multiple molecules somewhere in the workspace.
 * 
 * @author jonalv
 *
 */
public class PickMoleculesDialog extends TitleAreaDialog 
     ...
     */
    public PickMoleculesDialog( Shell parentShell ) {
        super( parentShell );
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setTitle( title == null ? "Select molecules"
                                : title);
        setMessage( message == null ? "Select one or many molecules from " +
        		                      "your workspace" 
                                    : message );
        return dialogArea;
    }
    ...
    public List<IFile> getSelectedFiles() {
        return new ArrayList<IFile>(selectedFiles);
    }
