...
/**
 * This is the item provider adapter for a {@link net.bioclipse.qsar.ParameterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterType_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterType_key_feature", "_UI_ParameterType_type"),
				 QsarPackage.Literals.PARAMETER_TYPE__KEY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ParameterType)object).getKey();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterType.class)) {
			case QsarPackage.PARAMETER_TYPE__KEY:
			case QsarPackage.PARAMETER_TYPE__VALUE:
