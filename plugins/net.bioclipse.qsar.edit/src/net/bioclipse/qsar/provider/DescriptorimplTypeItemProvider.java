...
/**
 * This is the item provider adapter for a {@link net.bioclipse.qsar.DescriptorimplType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptorimplTypeItemProvider
	 ...
	 * @generated
	 */
	public DescriptorimplTypeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DescriptorimplType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DescriptorimplType_name_feature", "_UI_DescriptorimplType_type"),
				 QsarPackage.Literals.DESCRIPTORIMPL_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNamespacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DescriptorimplType_namespace_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DescriptorimplType_namespace_feature", "_UI_DescriptorimplType_type"),
				 QsarPackage.Literals.DESCRIPTORIMPL_TYPE__NAMESPACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns DescriptorimplType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DescriptorimplType"));
	}
	...
	public String getText(Object object) {
		String label = ((DescriptorimplType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DescriptorimplType_type") :
			getString("_UI_DescriptorimplType_type") + " " + label;
	}
