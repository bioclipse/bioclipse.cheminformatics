        ...
        protected void addFilePropertyDescriptor(Object object) {
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 getResourceLocator(),
                                 getString("_UI_MoleculeResourceType_file_feature"),
                                 getString("_UI_PropertyDescriptor_description", "_UI_MoleculeResourceType_file_feature", "_UI_MoleculeResourceType_type"),
                                 QsarPackage.Literals.MOLECULE_RESOURCE_TYPE__FILE,
                                 true,
                                 false,
                                 false,
