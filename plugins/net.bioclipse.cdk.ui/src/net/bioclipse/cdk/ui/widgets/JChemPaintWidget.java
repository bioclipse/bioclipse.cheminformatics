 ...
 *******************************************************************************/
package net.bioclipse.cdk.ui.widgets;
...
public class JChemPaintWidget extends Canvas {
    ...
    public JChemPaintWidget(Composite parent, int style) {
        super(parent, style);
        renderer = new Java2DRenderer(new RendererModel());
...
//            System.out.println(("Nothing has changed. Done creating new Image."));
        ...
        try {
            ...
            GeometryTools.scaleMolecule(molecule, oldDimensions, 0.8);          
            GeometryTools.center(molecule, oldDimensions);
